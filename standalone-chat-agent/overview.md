...
- Team review environment (per-message feedback/annotation capture)
- Identity capture mechanism (name, email, phone — natural point in conversation)
- Data extraction (conversation content → questionnaire field mapping)
- Conversation summary generation (structured handoff for sales team)
